...
you'd like to enforce encryption and authentication for those connections, you may use the "SSH port forwarding" technic and  also set
up a local firewall (aka packet filter) to deny any other incoming connections but SSH.
