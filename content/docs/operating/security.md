...
Prometheus and Alertmanager store data in the local storage. The history of the
queries made using the Prometheus web UI, and the creator of a silence in
Alertmanager are save locally, amongst other data.
