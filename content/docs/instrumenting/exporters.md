...
separate exporters are needed:
   ...
   * [Gitea](https://docs.gitea.io/en-us/config-cheat-sheet/#metrics-metrics)
   ...
   * [Haproxy](https://www.haproxy.com/blog/haproxy-exposes-a-prometheus-metrics-endpoint/)
   ...
   * [PowerDNS](https://doc.powerdns.com/authoritative/http-api/index.html#metrics-endpoint)
   * [PowerDNS Recursor](https://doc.powerdns.com/recursor/http-api/prometheus.html)
