...
* `__meta_openstack_hypervisor_host_ip`: the IP address of the hypervisor.
* `__meta_openstack_hypervisor_hostname`: the name of the hypervisor.
* `__meta_openstack_hypervisor_status`: the status of the hypervisor.
* `__meta_openstack_hypervisor_state`: the state of the hypervisor.
* `__meta_openstack_hypervisor_type`: the type of the hypervisor.
