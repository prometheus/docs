...
Timestamps MUST be Unix Epoch in seconds. Timestamps MAY be floating point to represent sub-second precision, for example milliseconds or microseconds. Negative timestamps MAY be used.
