...
This blog post is part of a coordinated release between CNCF, Grafana, and Prometheus. Feel free to also read the [CNCF announcement]() and the angle on the [Grafana Agent which underlies the Prometheus Agent](https://grafana.com/blog/2021/11/16/why-we-created-a-prometheus-agent-mode-from-the-grafana-agent).
