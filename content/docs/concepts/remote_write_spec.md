...
A test suite can be found at https://github.com/prometheus/compliance/tree/main/remote_write.
...
- [Elastic Agent](https://docs.elastic.co/integrations/prometheus) (as both a "sender" and a "receiver")
