...
### Miscellaneous
   ...
   * [Duplicacy exporter](https://github.com/GeiserX/duplicacy-exporter) Exports real-time Duplicacy backup metrics including progress, speed, and completion status.
