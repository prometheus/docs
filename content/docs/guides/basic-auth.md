...
NOTE: Although basic auth connections *to* Prometheus instances are not supported, basic auth is supported for connections *from* Prometheus instances to scrape targets using simple [configurations](../../alerting/configuration/#http_config).
